        ...
        {sortedProperties.map((property, index) => {
          ...
          return (
            <li key={property.property_id}>
              ...
              >
                <div className="h-7 w-7 rounded-full bg-[hsl(var(--label-1)/0.06)] flex items-center justify-center flex-shrink-0">
                  <span className="text-[11px] font-semibold text-[hsl(var(--label-2)/0.78)] tabular-nums">
                    {index + 1}
                  </span>
                </div>
