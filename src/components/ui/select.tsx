...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between gap-2 rounded-xl px-3.5 py-2 text-[15px] tracking-[-0.01em]",
      ...
      "focus:outline-none focus:bg-white/85 dark:focus:bg-white/[0.10]",
      "focus:border-primary/50 focus:shadow-[0_0_0_4px_hsl(var(--primary)/0.18),inset_0_1px_0_rgba(255,255,255,0.7)]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-lg py-2 pl-8 pr-2 text-[14px] outline-none",
