...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-2xl p-1.5",
        "bg-white/72 dark:bg-[hsl(240,10%,12%)]/72",
        "backdrop-blur-[50px] backdrop-saturate-200",
        "border border-black/[0.06] dark:border-white/[0.08]",
        "shadow-[0_12px_40px_rgba(0,0,0,0.12),0_2px_8px_rgba(0,0,0,0.06)]",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-lg px-2.5 py-2 text-[14px] outline-none transition-colors duration-100",
      "focus:bg-foreground/[0.06] dark:focus:bg-white/[0.08] focus:text-foreground",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-foreground/[0.08] dark:bg-white/[0.08]", className)}
    {...props}
  />
))
