...
export function FacturationTabs() {
  ...
  return (
    <div className="rounded-[14px] bg-white/[0.04] border border-white/[0.04] p-1 flex flex-wrap gap-1">
      {tabs.map((t) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex-1 min-w-fit px-4 py-2.5 rounded-[10px] text-sm font-medium",
