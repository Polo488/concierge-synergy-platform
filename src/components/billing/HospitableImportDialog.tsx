...
interface HospitableImportDialogProps {
  open: boolean;
...
export function HospitableImportDialog({
  open,
  onOpenChange,
  onImport,
  isLoading = false,
}: HospitableImportDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Importer des données Hospitable</DialogTitle>
          <DialogDescription>
            Sélectionnez une période pour importer les réservations depuis Hospitable.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-6 space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <ul className="list-disc list-inside mt-2 ml-2 space-y-1">
              ...
              <li>Toutes les transactions liées aux réservations</li>
            </ul>
          </div>
        </div>
